...
namespace GalClash {
    ...
    class GCDB extends \Tiger\DB_PDO
    {
        ...
        public function get_nul_ally()
        {
            return $this->nul_ally;
        }

        public function get_nul_player()
        {
            return $this->nul_player;
        }
        ...
        public function get_vacation($user)
        {
        ...
        public function update_vacation($user, $date)
        {
        ...
        public function del_ally($ally)
        {
            ...
            try {
                ...
                foreach ($players as $name) {
                    $this->del_user($name, false, false);
                }  // do normal del_user without change ally and local transaction(!!)
                $sth->bindValue(':a_id', $a_id, PDO::PARAM_INT);
                $sth->execute();
