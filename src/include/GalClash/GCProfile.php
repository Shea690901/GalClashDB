                ...
                <fieldset>
                    ...
                    <table border="0" cellpadding="0" cellspacing="4">
                        <tr>
                            ...
                            <td><input name="date" id="urlaub" type="text" size="10" maxlength="10" value="<?php print($this->db->get_vacation($this->ses->user));
            ?>"/></td>
